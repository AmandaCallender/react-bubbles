...
A token is used to autheticate users into a website so that unauthorized users are not allowed access to sensitive areas.

- [x] What steps can you take in your web apps to keep your data secure?

You can use tokens and encrypt your data, as well as creating a username and password login system. 

- [x] Describe how web servers work.

Web servers host the code that makes up the web page, so that other people can access the web page online they can just access the server that the internet is connected to. 
